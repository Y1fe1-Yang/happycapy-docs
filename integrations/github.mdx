...
After connecting to GitHub, Happycapy can help you manage code repositories, create and view Issues, process Pull Requests, and check CI/CD status. You just tell Happycapy what you want to do using natural language.

## Get GitHub Token

A Token allows Happycapy to operate GitHub on your behalf. Here's how to get one:
...
You don't need to remember any commands - just communicate in natural language.
...
After writing code with Happycapy, you can save it to GitHub:
