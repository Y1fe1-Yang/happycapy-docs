...
<Tip>
  ...
  ```
  Find the JSONL log for session <id> under /home/node/.claude/projects/ and help me figure out what went wrong.
  ```

  Claude will locate the file, read through the conversation history, and diagnose the issue.
</Tip>
